<?php
session_start();
if (isset($_SESSION['id']) && isset($_SESSION['user_name']) && isset($_SESSION['Class'])) {
    ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center py-1">
                                            <div class="col-md-5 ps-5">
                                                ...
                                                <h6 class="mb-0" style="color:white;">Class</h6>

                                            </div>
                                            <div class="col-md-7 pe-5">

                                                <input type="email" class="form-control form-control"
                                                    placeholder="<?php echo $_SESSION['Class']; ?>" />
                                        ...
                                        <div class="row align-items-center py-3">
                                            <div class="col-md-4 ps-5">
                                                ...
                                                <a href=" userlogout.php"><button type="submit"
                                                        class="btn btn-sm">Logout</button></a>
                                            </div>
                                            <div class="col-md-4 ps-3">
                                            <a href="internal.php"><button type="submit"
                                                        class="btn btn-sm">Internal Marks</button></a>


                                            </div>
                                            <div class="col-md-4 ps-3">
                                                <!-- Assuming $id contains the student ID -->
                                                <a href="sem.php"><button type="submit"
                                                        class="btn btn-sm">Sem Marks</button></a>
