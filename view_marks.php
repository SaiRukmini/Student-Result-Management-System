...
";
        ...
        if ($result !== false) {
            ...
            if ($row) {
                ...
                $sum = ($telugu + $hindi + $english + $maths + $science + $social) / 60;
                $roundedSum = round($sum, 2);
                if ($telugu > 90 || $hindi > 90 || $english > 90 || $maths > 90 || $science > 90 || $social > 90 || $sum > 90) {
                    $G = "EX";
                } else if (($telugu > 80 && $telugu <= 90) || ($hindi > 80 && $hindi <= 90) || ($english > 80 && $english <= 90) || ($maths > 80 && $maths <= 90) || ($science > 80 && $science <= 90) || ($social > 80 && $social <= 90) || ($sum > 80 && $sum <= 90)) {
                    $G = "A";
                } else if (($telugu > 70 && $telugu <= 80) || ($hindi > 70 && $hindi <= 80) || ($english > 70 && $english <= 80) || ($maths > 70 && $maths <= 80) || ($science > 70 && $science <= 80) || ($social > 70 && $social <= 80) || ($sum > 70 && $sum <= 80)) {
                    $G = "B";
                } else if (($telugu > 60 && $telugu <= 70) || ($hindi > 60 && $hindi <= 70) || ($english > 60 && $english <= 70) || ($maths > 60 && $maths <= 70) || ($science > 60 && $science <= 70) || ($social > 60 && $social <= 70) || ($sum > 60 && $sum <= 70)) {
                    $G = "C";
                } else if (($telugu > 50 && $telugu <= 60) || ($hindi > 50 && $hindi <= 60) || ($english > 50 && $english <= 60) || ($maths > 50 && $maths <= 60) || ($science > 50 && $science <= 60) || ($social > 50 && $social <= 60) || ($sum > 50 && $sum <= 60)) {
                    $G = "D";
                } else if (($telugu >= 40 && $telugu <= 50) || ($hindi >= 40 && $hindi <= 50) || ($english >= 40 && $english <= 50) || ($maths >= 40 && $maths <= 50) || ($science >= 40 && $science <= 50) || ($social >= 40 && $social <= 50) || ($sum > 40 && $sum <= 50)) {
                    $G = "P";
                } else {
                    $G = "R";
                }
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row align-items-center pt-1 pb-1">
                                                ...
                                                <div class="col-md-5 ps-5">
                                                    ...
                                                    <h6 class="mb-0" style="color:black;">Total GPA</h6>

                                                </div>
                                                <div class="col-md-3 pe-5">
                                                    <input type="text" class="form-control form-control-sm"
                                                        placeholder="<?php echo $roundedSum; ?>" />
                                            ...
                                            <div class="row align-items-center pt-1 pb-1">
                                                <div class="col-md-6 ps-5">
                                                    ...
                                                    <form id="pdf-form" action="pdf.php" method="get">
                                                        <input type="hidden" name="telugu" value="<?php echo $telugu; ?>">
                                                        <input type="hidden" name="hindi" value="<?php echo $hindi; ?>">
                                                        <input type="hidden" name="english" value="<?php echo $english; ?>">
                                                        <input type="hidden" name="maths" value="<?php echo $maths; ?>">
                                                        <input type="hidden" name="science" value="<?php echo $science; ?>">
                                                        ...
                                                        <button type="submit" name="submit" class="btn border white-border btn-sm">Print
                                                            Result</button>
                                                    </form>
                                                </div>

                                                <div class="col-md-6 ps-5">
                                                <form id="pdf-form" action="graph.php" method="get">
                                                        <input type="hidden" name="telugu" value="<?php echo $telugu; ?>">
                                                        <input type="hidden" name="hindi" value="<?php echo $hindi; ?>">
                                                        <input type="hidden" name="english" value="<?php echo $english; ?>">
                                                        <input type="hidden" name="maths" value="<?php echo $maths; ?>">
                                                        <input type="hidden" name="science" value="<?php echo $science; ?>">
                                                        <input type="hidden" name="social" value="<?php echo $social; ?>">
                                                        <button type="submit" name="submit" class="btn border white-border btn-sm">Performance Graph
                                                            </button>
                                                    </form>
                                            ...
                                            <script>
                                                document.addEventListener("DOMContentLoaded", function () {
                                                    document.getElementById("pdf-button").addEventListener("click", function () {
                                                        // Add your subject marks to the URL as query parameters
                                                        var exportUrl = "pdf.php" +
                                                            "?telugu=" + <?php echo $telugu; ?> +
                                                            "&hindi=" + <?php echo $hindi; ?> +
                                                            "&english=" + <?php echo $english; ?> +
                                                            "&maths=" + <?php echo $maths; ?> +
                                                            "&science=" + <?php echo $science; ?> +
